...
from .robot_audio import AudioController
...
class G1_29_ArmController:
    def __init__(self, networkInterface='enxa0cec8616f27'):
        ...
        # Play a random robot quote on startup using AudioController
        audio_controller = AudioController()
        audio_controller.play_random_quote()
    ...
    def get_current_dual_arm_torque(self):
