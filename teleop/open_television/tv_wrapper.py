...
class TeleVisionWrapper:
    ...
    def get_data(self):
        ...
        logging.info(f"Wrist flags - left: {left_wrist_flag}, right: {right_wrist_flag}")
        ...
        logging.debug(f"After world-to-head transform - left wrist: {unitree_left_wrist}")
        logging.debug(f"After world-to-head transform - right wrist: {unitree_right_wrist}")
